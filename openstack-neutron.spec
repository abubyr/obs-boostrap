...
Source0: neutron-2014.1.3.tar.gz
...
%changelog
* Thu Oct 23 2014 Ilya Shakhat <ishakhat@mirantis.com> - 2014.1.3-fuel5.1.1.mira0
- 55a7c32 Merge remote-tracking branch 'origin/stable/icehouse' into openstack-ci/fuel-5.1.1/2014.1.1
- 6915af5 Merge "Skip lbaas table creation if tables already exist" into stable/icehouse
- 6b0cf98 Merge "Cisco N1kv: Remove vmnetwork delete REST call on last port delete" into stable/icehouse
- 52baa45 Merge "Neutron does not follow the RFC 3442 spec for DHCP" into stable/icehouse
- 3edce5f Merge "Raise exception for network delete with subnets presents" into stable/icehouse
- 6ee2043 Merge "Security Group rule validation for ICMP rules" into stable/icehouse
...
- a457acc Merge "Add quotas to Cisco N1kv plugins supported extension aliases" into stable/icehouse
- eebfc50 Merge "Fix error adding security groups to instances with nexus" into stable/icehouse
- 445aa11 Merge "Enforce required config params for ODL driver" into stable/icehouse
- 2e3483d Merge "Provide way to reserve dhcp port during failovers" into stable/icehouse
- 534bfbc Raise exception for network delete with subnets presents
- f9529ab Merge "update vsm credential correctly" into stable/icehouse
- 5ae3de6 Merge "Networks are not scheduled to DHCP agents for Cisco N1KV plugin" into stable/icehouse
- f6fc123 Merge "Add BSN plugin to agent migration script" into stable/icehouse
...
- b034f9d Bump stable/icehouse next version to 2014.1.4
...
- e2b50de Use RPC instead of neutron client in metadata agent
- b2b8436 Add missing ml2 plugin to migration 1fcfc149aca4
- 7eb5b5f OVS agent: Correct bridge setup ordering
- 0bec0b8 Merge "Avoid RequestURITooLong exception in metadata agent" into openstack-ci/fuel-5.1/2014.1.1
- 2300b95 Avoid RequestURITooLong exception in metadata agent
- 2fdc595 Provide way to reserve dhcp port during failovers
- 7b6d36c CVE-2014-3555 no quota for allowed address pair
- 92ebb1e Merge branch 'stable/icehouse' into openstack-ci/fuel-5.1/2014.1.1
- 9b4a458 Merge "Add losted root-wrapper for ip netns list call" into openstack-ci/fuel-5.0.1/2014.1.1
- 56c0ab0 Dispose db connections pool on disconnect
- 26a4f64 Merge "RFC5424: add use_syslog_rfc_format" into openstack-ci/fuel-5.0.1/2014.1.1
- 5a0ea10 Merge "Added catching of errors 1047 (Galera) for MySQL oslo db reconnect" into openstack-ci/fuel-5.0.1/2014.1.1
- b75ff78 Port kombu_reconnect_delay from oslo.mesaging
- 8f7ff96 Added catching of errors 1047 (Galera) for MySQL oslo db reconnect
- 91700c1 Add losted root-wrapper for ip netns list call
- bbe2bf5 RFC5424: add use_syslog_rfc_format
